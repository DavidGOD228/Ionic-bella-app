    ...
    <IonPage style={{ justifyContent: 'flex-start' }} className={'main-component'}>
      ...
      <div className="scroll-wrapper" >
        ...
        <IonContent className="service-container" style={{ flex: 2 }}>
          {servicesList.map((service, index) => <div className="service-item" key={service.id} onClick={() => onSelectService(service,)}>
            <div className="">
      ...
      {selectedService.length &&
                <div className="selected-services-modal">
                  ...
                  <div className="selected-services-modal-wrapper">
                    {selectedService.map((service) => <div key={service.id} className={'selected-services-modal-item'}>
