...
import {IAffiliates, IComment, ISpecialist} from "../../interfaces/interfaces";
import {IonAvatar, IonBackButton, IonButtons, IonHeader, IonToolbar} from "@ionic/react";
...
export const SpecialistDetail = () => {
    ...
    return(
        <div className={'wrapper-detail'}>
            ...
            {specialist.comments.map((comment) => (
